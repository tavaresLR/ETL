...
SELECT VACODEMP AS EMPRESA, VAMATFUNC AS MATRICULA, VADTREFER AS REFERENCIA,
  ...
  AND VACODFOLHA = 5
  AND VADTREFER BETWEEN 201709 AND 201808
  GROUP BY VACODEMP, VAMATFUNC, VADTREFER
	...
	CASE FUESTCIVIL
		...
		CONVERT(VARCHAR(11),CONVERT(DATE,CONVERT(VARCHAR(11),OFDTINIOCO),112), 103) AS DATA_DEMISSÃO,
...
FROM FUNCIONA
	...
	WHERE OFDTINIOCO BETWEEN 20170901 AND 20180831
	AND OFCODOCORR = 1004
	AND FUCODEMP < 500
